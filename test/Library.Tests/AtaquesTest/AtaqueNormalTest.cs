...
public class AtaqueNormalTests
{
    ...
    public void TestEjecutarAtaque_DañoCorrecto()
    {
        ...
        Pokemon oponente = new Pokemon(1, "Bulbasaur", 50, 20, "Hierba", new List<IAtaque>());

        // Crear un ataque normal
        AtaqueNormal ataqueNormal = new AtaqueNormal("Impactrueno", 10, "Electrico");
        
        // Calcular daño esperado
        double dañoEsperado = 10; // Cambiar según la lógica de tu sistema si es más complejo
        double hpEsperado = oponente.Hp - (dañoEsperado - 20);

        // Act
        string salida = ataqueNormal.Ejecutar_Ataque(oponente);
